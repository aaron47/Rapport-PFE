...
\input{sprint0/identificationdesbesoins}
\input{sprint0/diagcuglobal}
\input{sprint0/backlogduproduit}
\input{sprint0/plannificationderelease}
\input{sprint0/architecture}
\input{sprint0/environmentdev}